    ...
    <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-xl">
      <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-slate-900 text-lg">Live Delivery Rate Engine</h3>
            <p className="text-xs text-slate-500">Volumetric billing • Zone auto-detection • COD surcharges</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-1 bg-slate-100 p-1 rounded-lg">
                <button
                  ...
                  className={`py-1.5 text-xs font-semibold rounded-md transition ${
                    orderType === "B2C" ? "bg-white text-indigo-600 shadow-sm" : "text-slate-600 hover:text-slate-900"
                  }`}
                >
                  B2C Retail
                </button>
                <button
                  ...
                  className={`py-1.5 text-xs font-semibold rounded-md transition ${
                    orderType === "B2B" ? "bg-white text-indigo-600 shadow-sm" : "text-slate-600 hover:text-slate-900"
                  }`}
                >
                  B2B Bulk
                </button>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-1 bg-slate-100 p-1 rounded-lg">
                <button
                  ...
                  className={`py-1.5 text-xs font-semibold rounded-md transition ${
                    paymentType === "PREPAID" ? "bg-white text-indigo-600 shadow-sm" : "text-slate-600 hover:text-slate-900"
                  }`}
                >
                  Prepaid
                </button>
                <button
                  ...
                  className={`py-1.5 text-xs font-semibold rounded-md transition ${
                    paymentType === "COD" ? "bg-white text-indigo-600 shadow-sm" : "text-slate-600 hover:text-slate-900"
                  }`}
                >
                  COD
                </button>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1 flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-indigo-600" /> Pickup Pincode
              </label>
              <input
                type="text"
                value={pickupPincode}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1 flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-rose-600" /> Drop Pincode
              </label>
              <input
                type="text"
                value={dropPincode}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1 flex items-center justify-between">
              <span className="flex items-center gap-1">
                <Box className="w-3.5 h-3.5 text-indigo-600" /> Dimensions (L × W × H in cm)
              </span>
              <span className="text-[11px] text-slate-500">Volumetric Divisor: 5000</span>
            </label>
            <div className="grid grid-cols-3 gap-2">
              <div>
                <input
                  ...
                  placeholder="L"
                  className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg text-center font-mono focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1 flex items-center gap-1">
                <Scale className="w-3.5 h-3.5 text-indigo-600" /> Actual Weight (kg)
              </label>
              <input
                type="number"
                step="0.1"
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1 flex items-center gap-1">
                <CreditCard className="w-3.5 h-3.5 text-indigo-600" /> Declared Value ($)
              </label>
              <input
                type="number"
                min="0"
        ...
        <div className="lg:col-span-6 bg-slate-900 text-white rounded-xl p-6 flex flex-col justify-between relative overflow-hidden">
          ...
          <div>
            ...
            {error ? (
              <div className="p-4 rounded-lg bg-rose-900/40 border border-rose-800 text-rose-300 text-xs flex items-center gap-2">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-800/80 p-3 rounded-lg border border-slate-700/80 space-y-1.5 text-xs">
